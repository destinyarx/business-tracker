...
export function LandingHowItWorks() {
  return (
    <section
      id="how"
      className="scroll-mt-[72px] bg-[#16292B] px-5 py-[74px] text-white transition-colors dark:bg-[#12201F] sm:px-8 lg:px-11"
    >
      <div className="mx-auto max-w-[1400px]">
        ...
        <div className="mt-11 grid gap-8 md:grid-cols-3 md:gap-6">
          {landingSteps.map((step) => (
            <article key={step.number} className="border-t border-[#12CDBE] pt-5">
